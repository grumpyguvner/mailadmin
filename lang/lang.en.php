...
$lang['user']['did_you_know'] = '<b>Did you know?</b> You can use tags in your email address (e.g. "me+<b>privat</b>@domain.tld") to move messages to a folder automatically (e.g. "<b>privat</b>").<br />The folder will be under your Inbox (e.g. "Inbox/<b>privat</b>") make sure that the subfolder is visible so you don\'t miss any emails!';
...
$lang['user']['looking_for_your_email'] = 'MailAdmin is to maintain your mailbox settings, if you were looking to access your email please use the Webmail button below:';
...
$lang['start']['mailcow_panel_detail'] = '<b>Mailbox users</b> are able to create time-limited aliases (spam aliases), change their password and spam filter settings.<br /><br />
	<b>Domain administrators:</b> create, modify or delete mailboxes and aliases, change domains and read further information about their assigned domains.';
...
$lang['delete']['remove_mailbox_details'] = 'The mailbox will be <b>purged permanently</b>! You will not be able to access the mailbox and all emails for the mailbox will be permanently deleted.';
